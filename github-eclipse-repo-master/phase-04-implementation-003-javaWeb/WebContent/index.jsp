...
<body class="background1">
	...
	<a href="/New.jsp" style="font-size:30px" >跳转到空白页</a>
	<audio id="poem" src="/static/audio/poem.mp3"
		preload="auto"></audio>
		
    <span id="firstline" style="font-size: 22px; color: white">郭老师好！毕竟没学过JSP，我只是大概随便改改！“<span
	...
	<div id="poem-txt"
		style="display: none; font-size: 20px; color: orange; position:absolute; left :10px;top:50px" >
		《观沧海》<br /> <span style="font-size: 20px; color: red">
			-曹操 </span><br /> <br /> 日月之行，若出其中。 <br /> 星汉灿烂，若出其里。
	</div>
